...
function initBlogModal() {
    ...
    window.blogArticles = {
        ...
        'lacquer-trends': {
            ...
            content: `
                <p>Паркетните лакове се развиват постоянно, като новите технологии предлагат по-добра издръжливост, по-бързо съхнене и по-добри екологични характеристики. Като ексклузивен представител на италианските лакове Chemiver за североизточна България, винаги сме в крак с най-новите тенденции.</p>
                ...
                <ul>
                    ...
                    <li><strong>Chemiver специализирани продукти</strong> - ексклузивни за региона</li>
                </ul>
